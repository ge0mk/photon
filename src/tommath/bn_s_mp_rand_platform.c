...
#include <windows.h>
#include <wincrypt.h>
static mp_err s_read_getrandom(void*p, size_t n) { return MP_ERR; }
static mp_err s_read_arc4random(void*p, size_t n) { return MP_ERR; }
static mp_err s_read_urandom(void*p, size_t n) { return MP_ERR; }
static mp_err s_read_ltm_rng(void*p, size_t n) { return MP_ERR; }
